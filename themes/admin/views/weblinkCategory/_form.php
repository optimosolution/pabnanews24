...
<?php echo $form->DropDownListRow($model, 'parent_id', CHtml::listData(WeblinkCategory::model()->findAll(array('condition' => 'parent_id=0 AND published=1', "order" => "title")), 'id', 'title'), array('empty' => '--please select--', 'class' => 'span5')); ?>
