...
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'filter' => CHtml::activeDropDownList($model, 'category_id', CHtml::listData(NewsLinkCategory::model()->findAll(array('condition' => '', "order" => "title")), 'id', 'title'), array('empty' => 'All')),
